...
Open via **Tools → Toolbar Shortcuts → Shortcuts Window**.
...
| Issue | Suggestion |
|-------|------------|
| Setup did not change the toolbar | Run **Tools → Toolbar Shortcuts → Setup Toolbar** after the editor finishes compiling |
...
| Welcome shows again | **Tools → Toolbar Shortcuts → Reset Setup State**, then reimport or run Setup |
